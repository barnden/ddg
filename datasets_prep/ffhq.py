...
class Dataset(th.utils.data.Dataset):
    def __init__(self, name, raw_shape, max_size=None, use_labels=False, xflip=False, random_seed=0):
        self._name = name
    ...
    def __getitem__(self, idx):
        ...
        return self.get_label(idx), image, [0]
